...
private:
    ...
    std::vector<const char*> getRequiredExtensions() {
        ...
        // Vulkan is platform agnostic, so ask GLFW for help
        ...
        for (const auto& requiredExtension : extensions) {
            ...
            if (found == std::end(availableExtensions)) {
                throw std::runtime_error(requiredExtension + std::string{ " is not supported!" });
            }
        }
    ...
    bool isDeviceSuitable(const VkPhysicalDevice& device) {
        ...
        std::cout << std::boolalpha << indices.isComplete() << "\n";
